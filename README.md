...
|------|-------|----------------|-------------|
| I    | 0-40  | L1 + SSIM (0.8 / 0.2) | Стартовый LR = 5e-4, AdamW, косинусное затухание |
| II   | 40-42 | L1 + SSIM (0.5 / 0.5) | Усиление структурной компоненты |
| III  | 42-60 | Только L1         | Перезагрузка обучения, Adam (без весов) |
| IV   | 60-70 | L1 + SSIM + VGG (0.3 / 0.6 / 0.1) | Введение перцептивной потери |
| V    | 70-75 | L1 + SSIM + VGG (0.3 / 0.7 / 0.25) | Финальный баланс, низкий LR |
...
├── test_images/          # Примеры для тестирования
│
